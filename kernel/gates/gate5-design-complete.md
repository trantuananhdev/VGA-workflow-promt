...
4. **Handoff body có đủ field cô đặc** theo `kernel/rules/handoff-contracts.md` cạnh `designer-screen → mobile-screen`: `ui_states_count`, `data_bindings_summary`, `domains_applied`, `responsive_tiers_covered`, `components_used`, có slot quảng cáo hay không.
