...
**Khi FAIL:** `qa` emit `bug_report.md` + `type: handoff` về đúng agent gây lỗi (`dev-be` cho lỗi backend, `client` cho lỗi client, `ads` cho vi phạm điều 5) — vòng quay lại Gate 3.
